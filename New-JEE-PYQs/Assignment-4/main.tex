...
\item The sum $1^2 - 2.3^2 + 3.5^2 - 4.7^2 + 5.9^2 - ....... + 15.29^2$ is 
...
\item Let $A$ be a $n \times n $ matrix such that $\abs{A} = 2$. If the determinant of the matrix $\operatorname{Adj}\brak{2.\operatorname{Adj}\brak{2A^{-1}}}$ is $2^{84}$, then $n$ is equal to 
