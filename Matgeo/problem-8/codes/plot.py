...
x_2 = points[201:400, 0]
y_2 = points[201:400, 1]
...
plt.fill_between(x_2, y_2, where=(x_2 <= 4.1), color='grey', alpha=0.3, label='Shaded Region')
plt.fill_between(x_1, y_1, where=(x_1 >= 4), color='grey', alpha=0.3, label='Shaded Region')
